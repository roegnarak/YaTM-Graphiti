...
public class TestmodelPackageImpl extends EPackageImpl implements TestmodelPackage {
	 ...
	 * @generated
	 */
	public EAttribute getAssociation_FirstLabel() {
	 ...
	 * @generated
	 */
	public EAttribute getAssociation_SecondLabel() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_First() {
	 ...
	 * @generated
	 */
	public EReference getAssociation_Second() {
	...
	public void createPackageContents() {
		...
		createEAttribute(associationEClass, ASSOCIATION__FIRST_LABEL);
		createEAttribute(associationEClass, ASSOCIATION__SECOND_LABEL);
		createEReference(associationEClass, ASSOCIATION__FIRST);
		createEReference(associationEClass, ASSOCIATION__SECOND);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, testmodel.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Attributes(), this.getAttribute(), this.getAttribute_Owner(), "attributes", null, 0, -1, testmodel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAssociation_FirstLabel(), ecorePackage.getEString(), "firstLabel", "*", 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssociation_SecondLabel(), ecorePackage.getEString(), "secondLabel", "*", 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociation_First(), this.getClass_(), null, "first", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAssociation_Second(), this.getClass_(), null, "second", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
