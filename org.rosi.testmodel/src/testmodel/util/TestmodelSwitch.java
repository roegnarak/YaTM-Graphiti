...
public class TestmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestmodelPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestmodelPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestmodelPackage.MODEL_ELEMENT: {
			...
			case TestmodelPackage.TYPED_ELEMENT: {
			...
			case TestmodelPackage.CLASS: {
				testmodel.Class class_ = (testmodel.Class)theEObject;
			...
			case TestmodelPackage.ATTRIBUTE: {
			...
			case TestmodelPackage.ASSOCIATION: {
	 ...
	 * @generated
	 */
	public T caseClass(testmodel.Class object) {
		return null;
	}
